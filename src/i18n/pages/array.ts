export default {
    hy: {
        docTitle: "JS.CORE | Մասիվներ (Arrays)",
        metaDescription:
            "JavaScript մասիվների խորացված ուղեցույց. push/pop, shift/unshift մեթոդներ, արտադրողականություն և շրջանցման եղանակներ:",
        nav: { basics: "Հիմունքներ", methods: "Մեթոդներ", loops: "Շրջանցում" },
        h1: "Մասիվներ (Arrays)",
        subtitle:
            '"Մասիվը հզոր գործիք է տվյալները կարգավորված պահելու և արդյունավետ մշակելու համար:"',
        glElement: "Element",
        glElementP: "Մասիվում պահվող արժեքը:",
        glIndex: "Index",
        ...
        s01Lead:
            "Մասիվները օբյեկտների հատուկ տեսակ են, որոնք նախատեսված են <b>կարգավորված</b> տվյալներ պահելու համար:",
        ...
        s01FreeP:
            "Մասիվը կարող է պահել <b>ցանկացած</b> տեսակի տվյալ՝ string, number, boolean, object և նույնիսկ այլ մասիվներ:",
        s01TypeTitle: "Տիպի ճշգրիտ ստուգում",
        s01TypeFoot:
            "* Քանի որ JS-ում մասիվը օբյեկտ է, <code>typeof</code>-ը միշտ կվերադարձնի \"object\": Ճիշտ ստուգման համար միշտ օգտագործեք <code>Array.isArray()</code>:",
        s01DiagP:
            "Մասիվը հիշողության մեջ (Heap) պահվում է որպես օբյեկտ՝ հատուկ ներքին կառուցվածքով, որտեղ length-ը ավտոմատ թարմացվող հատկություն է:",
        ...
        s03Title: "Մասիվների Շրջանցում",
        s03ForTitle: "for...of ցիկլ",
        s03ForP: "Ամենապարզ և ժամանակակից ձևը արժեքները ստանալու համար:",
        s03LenTitle: "length հատկությունը",
        s03LenP:
            "<code>arr.length</code>-ը միշտ վերադարձնում է վերջին ինդեքսը + 1: Այն կարելի է օգտագործել նաև մասիվը մաքրելու համար՝ <code>arr.length = 0</code>:",
        s03LenTip:
