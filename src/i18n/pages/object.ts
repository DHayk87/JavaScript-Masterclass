export default {
  hy: {
    ...
    subtitle:
      '"Օբյեկտները JavaScript-ի հիմնական կառուցվածքային միավորներն են:"',
    ...
    s01Code: `<span class="hl-kw">let</span> user = {<br/>
&nbsp;&nbsp;name: <span class="hl-str">"John"</span>,<br/>
&nbsp;&nbsp;age: <span class="hl-num">30</span><br/>
};`,
