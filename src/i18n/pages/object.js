export default {
    hy: {
        ...
        nav: { basics: "Հիմունքներ", access: "Հասանելիություն", loops: "Ցիկլեր", references: "Հղումներ" },
        ...
        s01LiAdd: '<span class="dot"></span> <b>Ավելացում:</b> <code>user.isAdmin = true;</code>',
        s01LiDel: '<span class="dot"></span> <b>Հեռացում:</b> <code>delete user.age;</code>',
        s01LiComma:
        ...
        s02BrP:
            "Օգտագործվում է բարդ բանալիների կամ դինամիկ փոփոխականների դեպքում:",
        s02InTip:
        ...
        s03ProLi1:
            '<span class="dot"></span> <b>Մասիվներ:</b> Խուսափեք <code>for..in</code>-ից մասիվների դեպքում:',
        s03ProLi2:
        ...
        s04GcP:
            'Եթե օբյեկտին տանող բոլոր հղումները ջնջվում են, այն դառնում է <b>\"Unreachable\"</b>:',
    ...
    en: {
        ...
        nav: { basics: "Basics", access: "Access", loops: "Loops", references: "References" },
        h1: "Objects",
        ...
        s01LiAdd: '<span class="dot"></span> <b>Add:</b> <code>user.isAdmin = true;</code>',
        s01LiDel: '<span class="dot"></span> <b>Remove:</b> <code>delete user.age;</code>',
        s01LiComma:
        ...
        s03Lead:
            "<code>for...in</code> enumerates enumerable string keys of an object.",
        s03PassTitle: "Iteration",
        s03IntTitle: 'The “integer index” rule',
        s03IntP:
            "Keys that look like array indices may be visited in numeric order.",
        s03ExTitle: "Example",
        ...
        s04Title: "References",
        s04Lead:
            "Objects are stored and copied <b>by reference</b>, unlike primitives.",
        s04RememberTitle: "Remember",
        s04RememberP: "Assigning or passing an object copies the reference, not the object “contents”.",
        ...
        s04GcP:
            'When no references remain, the object becomes <b>unreachable</b> and can be collected.',
    ...
    ru: {
        ...
        s01LiAdd: '<span class="dot"></span> <b>Добавить:</b> <code>user.isAdmin = true;</code>',
        s01LiDel: '<span class="dot"></span> <b>Удалить:</b> <code>delete user.age;</code>',
        s01LiComma:
        ...
        s04CmpP:
            "<code>{} === {}</code> — <b>false</b>, потому что сравниваются ссылки.",
        s04GcTitle: "Сборка мусора",
        s04GcP:
            "Если ссылок не осталось, объект становится <b>недостижимым</b>.",
