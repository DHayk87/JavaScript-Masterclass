export default {
  hy: {
    ...
    s02Code: `<span class="hl-cm">// Պատկերացնենք տվյալների ստացում սերվերից</span><br/>
<span class="hl-kw">async function</span> <span class="hl-fn">getUserData</span>() {<br/>
&nbsp;&nbsp;<span class="hl-kw">try</span> {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Հարցումն ուղարկված է..."</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Ծրագիրը սպասում է այստեղ, մինչև fetch-ը կավարտվի</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> response = <span class="hl-kw">await</span> <span class="hl-fn">fetch</span>(<span class="hl-str">'https://api.example.com/user'</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Սպասում է, մինչև JSON-ը պատրաստ լինի</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> data = <span class="hl-kw">await</span> response.<span class="hl-fn">json</span>();<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Տվյալները ստացված են:"</span>, data);<br/>
&nbsp;&nbsp;} <span class="hl-kw">catch</span> (error) {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">error</span>(<span class="hl-str">"Սխալ տեղի ունեցավ:"</span>, error);<br/>
&nbsp;&nbsp;}<br/>
}`,
    ...
    trReadD: "Կոդը դառնում է գծային: Չկան երկար <code>.then()</code> շղթաներ:",
    ...
    tipP: "Մի քանի անկախ հարցումների դեպքում մի օգտագործեք հերթական <code>await</code> ամեն տողում — դա դանդաղեցնում է: Օգտագործեք <code>Promise.all()</code> զուգահեռության համար:",
    prevTopic: "Promises",
  ...
  en: {
    ...
    s01AsyncP:
      "Placed before a function, it guarantees the function returns a promise.",
    s01AsyncLi1:
      '<span class="dot"></span> The return value is always a promise.',
    s01AsyncLi2:
    ...
    s02Code: `<span class="hl-cm">// Fetching data from an API</span><br/>
<span class="hl-kw">async function</span> <span class="hl-fn">getUserData</span>() {<br/>
&nbsp;&nbsp;<span class="hl-kw">try</span> {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Request sent..."</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Pauses here until fetch is settled</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> response = <span class="hl-kw">await</span> <span class="hl-fn">fetch</span>(<span class="hl-str">'https://api.example.com/user'</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Wait until JSON is parsed</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> data = <span class="hl-kw">await</span> response.<span class="hl-fn">json</span>();<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Data received:"</span>, data);<br/>
&nbsp;&nbsp;} <span class="hl-kw">catch</span> (error) {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">error</span>(<span class="hl-str">"Error occurred:"</span>, error);<br/>
&nbsp;&nbsp;}<br/>
}`,
    ...
    tipP: "For independent calls, don’t await them one-by-one—run them with <code>Promise.all</code> (or <code>allSettled</code>) and await the combined promise.",
    prevTopic: "Promises",
    nextTopic: "Home",
  },
  ru: {
    ...
    s02Code: `<span class="hl-cm">// Представим получение данных с сервера</span><br/>
<span class="hl-kw">async function</span> <span class="hl-fn">getUserData</span>() {<br/>
&nbsp;&nbsp;<span class="hl-kw">try</span> {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Запрос отправлен..."</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Пауза до завершения fetch</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> response = <span class="hl-kw">await</span> <span class="hl-fn">fetch</span>(<span class="hl-str">'https://api.example.com/user'</span>);<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-cm">// Пауза до обработки JSON</span><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-kw">let</span> data = <span class="hl-kw">await</span> response.<span class="hl-fn">json</span>();<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">log</span>(<span class="hl-str">"Данные получены:"</span>, data);<br/>
&nbsp;&nbsp;} <span class="hl-kw">catch</span> (error) {<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="hl-type">console</span>.<span class="hl-fn">error</span>(<span class="hl-str">"Произошла ошибка:"</span>, error);<br/>
&nbsp;&nbsp;}<br/>
}`,
    ...
    tipP: "Для независимых запросов не делайте последовательные <code>await</code> — используйте <code>Promise.all</code> или <code>allSettled</code>.",
    prevTopic: "Промисы",
